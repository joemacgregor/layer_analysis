function unfence_nosave(year, trans, subtrans, layer)
% UNFENCE_NOSAVE Unfence a particular transect or layer of any matches (NOT SAVING).
%
% Joe MacGregor (UTIG)
...
id_layer_master_mat([ind2unfence{1}; ind2unfence{2}], :)
